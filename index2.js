    ...
    cards[i].addEventListener('click', function () {
        if (mode === 'animals') {
            ...
            if (arrayOfGame[i].name !== pickedImage.name) {
                ...
                setTimeout(function () { cards[i].remove(); }, 1100);
                array.push(cards[i]);
                ...
                setTimeout(function () { displayMessageWinner.style.display = 'none'; }, 2200);
                setTimeout(function () { clean(); }, 2200);
                setTimeout(function () {
                    array.forEach(elem => cards[i].parentElement.appendChild(elem))
                }, 2300);
                setTimeout(function () { reset(); }, 2700);
            }
        }
...
TO IMPROVE:
    ...
    - Work on accesibility (focus, etc.).
    - Refactor
